...
Una aplicación de escritorio moderna y ligera para descargar videos y playlists completas de YouTube en formato MP4 y la calidad de tu preferencia. Construida en Python con una interfaz gráfica intuitiva (CustomTkinter) y un sistema anti-ruptura inteligente para listas de reproducción mixtas.

## ✨ Características Principales

* **🖥️ Interfaz Gráfica Moderna:** UI limpia, atractiva y adaptable al modo del sistema.
* **🎛️ Selector de Calidad Inteligente:** Elige entre Máxima calidad, 1080p, 720p, 480p o 360p. Cuenta con un sistema seguro que detecta si un video de una playlist no tiene la resolución pedida y descarga automáticamente la máxima disponible sin romper la ejecución.
